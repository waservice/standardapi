...
{
    [Serializable]
    [System.Xml.Serialization.XmlRoot("AppointmentChangeResponse", Namespace = "http://wa.dms.webservice/AppointmentChangeResponse")]
    public class AppointmentChangeResponse
    {
        ...
        //private Appointment _appointment; public Appointment Appointment { get { return this._appointment; } set { this._appointment = value; } }
    }
}