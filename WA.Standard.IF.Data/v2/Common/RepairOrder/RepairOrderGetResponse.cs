...
{
    [Serializable]
    [System.Xml.Serialization.XmlRoot("RepairOrderGetResponse", Namespace = "http://wa.dms.webservice/RepairOrderGetResponse")]
    public class RepairOrderGetResponse
    {
        ...
        private List<RepairOrderDocument> _repairorderdocuments; public List<RepairOrderDocument> RepairOrderDocuments { get { return this._repairorderdocuments; } set { this._repairorderdocuments = value; } }
    }
}
